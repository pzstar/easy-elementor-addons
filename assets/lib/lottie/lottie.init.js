!(function (e, t) {
    "use strict";
    window.eeadLottie = new (function () {
        var o = this;
        (this.hoverEvent = function (e, t, o, n, i, a) {
            ...
            (this.onScroll = function (t, o) {
                e.waypoint(t, function () {
                    o.play();
                });
            }),
            (this.lottie = function (e) {
                var t = e.find(".eead_lottie"),
                    n = t.attr("id"),
                    i = t.data("speed"),
                    a = t.data("direction"),
                    r = t.data("action");
                (o[n] = bodymovin.loadAnimation({ container: t[0], path: t.data("path"), autoplay: t.data("autoplay"), loop: t.data("loop") || !1, renderer: t.data("renderer") })),
                    "" !== i && o[n].setSpeed(i),
                    "" !== a && o[n].setDirection(-1),
                    "" !== r && o.hover(r, t, o[n]),
                    "" !== t.data("on-scroll") && o.onScroll(t, o[n]);
            }),
            (this.init = function () {
                e.hooks.addAction("frontend/element_ready/eead-lottie-block.default", o.lottie);
            }),
