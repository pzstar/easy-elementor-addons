				...
				<div class="elementor-templates-modal__header">
					<div class="elementor-templates-modal__header__logo-area">
						<div class="elementor-templates-modal__header__logo">
							<span class="elementor-templates-modal__header__logo__icon-wrapper" id="eead-live-editor-logo">
								<span class="eead-template-modal-header-logo-icon">
								</span>
							</span>
							...
							<div class="eead-live-editor-title">
								<input type="text" id="eead-live-temp-title" name="premiumLiveTempTitle" placeholder="Enter template name...">
								<button id="eead-insert-live-temp" class="elementor-template-library-template-action eead-template-insert elementor-button elementor-button-success" ><?php esc_html_e( 'Save & Insert Template', 'easy-elementor-addons' ); ?></button>
					...
					<div class="elementor-templates-modal__header__items-area">
						<div class="elementor-templates-modal__header__close elementor-templates-modal__header__close--normal elementor-templates-modal__header__item">
							<i class="eicon-close" aria-hidden="true" title="<?php echo esc_attr__( 'Close', 'easy-elementor-addons' ); ?>"></i>
						...
						<div class="elementor-templates-modal__header__expand  elementor-templates-modal__header__item eead-expand">
							<i class="eicon-frame-expand" aria-hidden="true" title="<?php echo esc_attr__( 'Expand', 'easy-elementor-addons' ); ?>"></i>
