                ...
                <div class='eead-tiles-wrap'>
                    <# _.each( settings.eead_tile_elements, function( elements, index ) { #>
                        <div data-scroll class='eead-tiles-row' data-scroll-speed='2' data-scroll-direction='horizontal'>
                            <# _.each( elements.eead_tile_images, function( image, index ) { var imageObj={ id: image.id, url: image.url, size: settings.eead_tile_thumbnail_size, dimension: image.thumbnail_custom_dimension, model: view.getEditModel() }, image_url=elementor.imagesManager.getImageUrl( imageObj ); #>
