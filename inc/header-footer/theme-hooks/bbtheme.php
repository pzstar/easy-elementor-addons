<?php 
namespace EEAD\Modules\Header_Footer\Theme_Hooks;
...
class Bbtheme {
	...
	public function add_plugin_header_markup(){
		...
		?>
			<header id="masthead" itemscope="itemscope" itemtype="https://schema.org/WPHeader">
				<div class="eead-template-content-markup eead-template-content-header">
					<?php echo \EEAD\Utils::render_elementor_content($this->header); ?>
				</div>
			</header>
			<style>
				[data-type="header"] {
	...
	// footer actions
	  public function add_plugin_footer_markup(){
			...
			do_action('eead/template/before_footer'); ?>

				<footer itemscope="itemscope" itemtype="https://schema.org/WPFooter">
				<?php echo \EEAD\Utils::render_elementor_content($this->footer); ; ?>
				</footer>

			<?php 
			do_action('eead/template/after_footer');
    }
