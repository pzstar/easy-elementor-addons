...
class AnimatedHeading extends Widget_Base {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .eead-animated-heading-wrap .eead-pre-heading,
                 {{WRAPPER}} .eead-animated-heading-wrap .eead-post-heading' => 'color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        <<?php echo esc_html($html_tag); ?> class="eead-animated-heading-wrap <?php echo 'eead-align-'.$settings['alignment']; ?>">
