...
namespace EasyElementorAddons\Modules\MorphingLayouts\Widgets;
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => 'style-1-a',
                'options' => [
                    'style-1-a' => esc_html__('Style 1-A', 'easy-elementor-addons'),
                    'style-1-b' => esc_html__('Style 1-B', 'easy-elementor-addons'),
                    'style-1-c' => esc_html__('Style 1-C', 'easy-elementor-addons'),
                    'style-2-a' => esc_html__('Style 2-A', 'easy-elementor-addons'),
                    'style-2-b' => esc_html__('Style 2-B', 'easy-elementor-addons'),
                    'style-2-c' => esc_html__('Style 2-C', 'easy-elementor-addons'),
                    'style-3-a' => esc_html__('Style 3-A', 'easy-elementor-addons'),
                    'style-3-b' => esc_html__('Style 3-B', 'easy-elementor-addons'),
                    'style-3-c' => esc_html__('Style 3-C', 'easy-elementor-addons'),
                    'style-3-d' => esc_html__('Style 3-D', 'easy-elementor-addons'),
                    'style-3-e' => esc_html__('Style 3-E', 'easy-elementor-addons'),
                    'style-4-a' => esc_html__('Style 4-A', 'easy-elementor-addons'),
                    'style-4-b' => esc_html__('Style 4-B', 'easy-elementor-addons'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => 'none',
                'options' => [
                    'none' => esc_html__('Used Fixed Scroll', 'easy-elementor-addons'),
                    'style-1-a' => esc_html__('Style 1-A', 'easy-elementor-addons'),
                    'style-1-b' => esc_html__('Style 1-B', 'easy-elementor-addons'),
                    'style-1-c' => esc_html__('Style 1-C', 'easy-elementor-addons'),
                    'style-2-a' => esc_html__('Style 2-A', 'easy-elementor-addons'),
