...
class Astra {
    ...
    public function add_plugin_header_markup(){
			...
			echo '<div class="eead-template-content-markup eead-template-content-header">';
				echo \EEAD\Utils::render_elementor_content($this->header);
			echo '</div>';
    ...
    public function add_plugin_footer_markup(){
			...
			echo '<div class="eead-template-content-markup eead-template-content-footer">';
			echo \EEAD\Utils::render_elementor_content($this->footer); ;
			echo '</div>';
