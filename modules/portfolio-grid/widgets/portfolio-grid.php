    ...
    protected function render() {
        ...
        if ( $settings['list2'] ) { ?>
            ...
            <ul class="eead-fpg-search-wrapper">
                <li class="eead-fpg-mobile-icon"><label><span class="dashicons dashicons-menu-alt"></span></label></li>
                <?php foreach ( $settings['list2'] as $item ) { ?> 
                    <li>
                        <input id="eead-fpg-filter-<?php echo $settings_id; ?>-<?php echo esc_attr($item['filter_id']); ?>" type="radio" <?php if (isset($item['filter_default']) && $item['filter_default']) { ?>checked="checked"<?php } ?> name="filter" value="<?php echo esc_attr($item['filter_id']); ?>" style="display:none">
                        <label for="eead-fpg-filter-<?php echo $settings_id; ?>-<?php echo esc_attr($item['filter_id']); ?>" <?php if (isset($item['filter_default']) && $item['filter_default']) { ?>class="active"<?php } ?>><?php echo $item['filter_name']; ?></label>
                    </li>
                <?php } ?>
            </ul>
            <?php } ?>
            ...
            <ul class="eead-fpg-view-options">
                <li>
                    <input id="eead-fpg-show-grid-<?php echo $settings_id; ?>" type="radio" <?php if ($settings['layout_default'] == 'eead-fpg-grid-view') { ?>checked="checked"<?php } ?> name="view" value="show-grid" style="display:none">
                    <label for="eead-fpg-show-grid-<?php echo $settings_id; ?>" <?php if ($settings['layout_default'] == 'eead-fpg-grid-view') { ?>class="active"<?php } ?>><span class="dashicons dashicons-grid-view"></span></label>
                </li>
                <li>
                    <input id="eead-fpg-show-list-<?php echo $settings_id; ?>" type="radio" <?php if ($settings['layout_default'] == 'eead-fpg-list-view') { ?>checked="checked"<?php } ?> name="view" value="show-list" style="display:none">
                    <label for="eead-fpg-show-list-<?php echo $settings_id; ?>" <?php if ($settings['layout_default'] == 'eead-fpg-list-view') { ?>class="active"<?php } ?>><span class="dashicons dashicons-list-view"></span></label>
                </li>
            </ul>
            <?php } ?>
            </form>
        ...
        <?php if ( $settings['list'] ) { ?>
            <ol class="eead-fpg-container <?php echo $settings['layout_default'] . ' ' . $settings['grid_txt_placement']; ?> eead-fpg-zoom-in" style="display:none;">
                ...
                <li data-filter="<?php echo $item['item_filter_ids']; ?>" class="elementor-repeater-item-<?php echo $item['_id']; ?>">
                    ...
                    <figure>
                        ...
                        <figcaption>
                            <?php 
                            if (!empty($item['title'])) {
                                echo '<' . $settings['title_html_tag'] . ' class="eead-fpg-title">' . $item['title'] . '</' . $settings['title_html_tag'] . '>'; 
                            }
                            if (!empty($item['info'])) {
                                echo '<' . $settings['info_html_tag'] . ' class="eead-fpg-info">' . do_shortcode($item['info']) . '</' . $settings['info_html_tag'] . '>'; 
                            }
                            ?>
                        </figcaption>
                    </figure>
